...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname ejemplo-run-movie) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
(define BRAZO-COMPLETE-HOLLOW (place-image BRAZO-HOLLOW 85 55
                                    (place-image MANO-HOLLOW 60 90
                                      (place-image (rotate 45 ARMA) 20 50 (empty-scene 120 120 "black")))))
...
CABEZA-ISAAC
BRAZO-COMPLETE-HOLLOW

#|CODIGO|#


(define (fabrica-frank cuerpo cabeza patas mochila y-cabeza y-mochila)
   (place-image cabeza 100 y-cabeza
    (place-image cuerpo 100 130
        (place-image patas 100 195
         (place-image mochila 60 y-mochila HOJA)))))
...
;(fabrica-frank  CUERPO-AMONGUS CABEZA-STEVE PATAS-AMONGUS MOCHILA-AMONGUS)