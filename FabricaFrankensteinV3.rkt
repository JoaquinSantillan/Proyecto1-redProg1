...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname FabricaFrankensteinV3) (read-case-sensitive #t) (teachpacks ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp")) #f)))
...
(define (CABEZA-STEVE
         color-ojos posicion-ojos-azul-x posicion-ojos-azul-y posicion-ojos-azul-x-2 posicion-ojos-azul-y-2)
             (place-image
                ...
                (rectangle 22 10 "solid" "Saddle Brown")
                  ...
                  (place-image
                   (rectangle 50 20 "solid" "Brown")
                    50.5 58
                  (place-image
                   (rectangle 11 10 "solid" color-ojos)
                      posicion-ojos-azul-x posicion-ojos-azul-y;33 34
                    (place-image
                     (rectangle 22 10 "solid" "white")
                     27 34
                      (place-image
                       (rectangle 11 10 "solid" color-ojos)
                        posicion-ojos-azul-x-2 posicion-ojos-azul-y-2 ;68 34
                        (place-image
                         (rectangle 22 10 "solid" "white")
                          73 34
...
;ISAAC(JOAQUIN)
(define (CABEZA-ISAAC posicion-lagrimas-y) (place-image
                (circle 12 "solid" "black") 25 50
                 (place-image (circle 12 "solid" "black") 75 50
                   (place-image (rectangle 10 20 "solid" "Deep Sky Blue") 75  posicion-lagrimas-y
                    (place-image (rectangle 10 20 "solid" "Deep Sky Blue") 25 posicion-lagrimas-y ;70
...
;(fabrica-frank-numero-dos TORZO-ISAAC CABEZA-STEVE PATAS-ISAAC BRAZO-IZQ-ISAAC BRAZO-DERE-ISAAC "red" 10 20)
;:esto da como resultado un frank con cuerpo de el personaje isaac una cabeza del personaje steve
;unas patas del isaac un brazo del personaje ISAAC y en este caso pasamos primero la rotacion como
;parametro y la ubicacion en el eje y como parametro
...
(define (fabrica-frank-numero-dos-joaquin cuerpo cabeza pierna brazo-dere brazo-izq)
       (place-image
         brazo-dere 168 127
         (place-image
          brazo-izq 90 110
...
;TERCER-FRANK JOAQUIN
(define (fabrica-frank-numero-dos-joaqui cuerpo cabeza pierna mochila)
  (place-image cabeza 140 70
          (place-image cuerpo 140 130
          (place-image
           pierna 155 175
...
#|SEGUNDO-RUN-MOVIE-JOQUIN
(run-movie 0.2 (list (fabrica-frank-numero-dos-joaquin TORZO-ISAAC (CABEZA-STEVE "red" 33 34 68 34) PATAS-ISAAC BRAZO-IZQ-ISAAC BRAZO-DERE-ISAAC)
                     (fabrica-frank-numero-dos-joaquin TORZO-ISAAC (CABEZA-STEVE "yellow" 27 34 78 34) PATAS-ISAAC BRAZO-IZQ-ISAAC BRAZO-DERE-ISAAC)
                     (fabrica-frank-numero-dos-joaquin TORZO-ISAAC (CABEZA-STEVE "blue" 33 34 68 34) PATAS-ISAAC BRAZO-IZQ-ISAAC BRAZO-DERE-ISAAC)
                     (fabrica-frank-numero-dos-joaquin TORZO-ISAAC (CABEZA-STEVE "green" 27 34 78 34) PATAS-ISAAC BRAZO-IZQ-ISAAC BRAZO-DERE-ISAAC)
                     (fabrica-frank-numero-dos-joaquin TORZO-ISAAC (CABEZA-STEVE "black" 33 34 68 34) PATAS-ISAAC BRAZO-IZQ-ISAAC BRAZO-DERE-ISAAC)
                     (fabrica-frank-numero-dos-joaquin TORZO-ISAAC (CABEZA-STEVE "red" 27 34 78 34) PATAS-ISAAC BRAZO-IZQ-ISAAC BRAZO-DERE-ISAAC)
                     (fabrica-frank-numero-dos-joaquin TORZO-ISAAC (CABEZA-STEVE "yellow" 33 34 68 34) PATAS-ISAAC BRAZO-IZQ-ISAAC BRAZO-DERE-ISAAC)
                     (fabrica-frank-numero-dos-joaquin TORZO-ISAAC (CABEZA-STEVE "green" 27 34 78 34) PATAS-ISAAC BRAZO-IZQ-ISAAC BRAZO-DERE-ISAAC)
                     (fabrica-frank-numero-dos-joaquin TORZO-ISAAC (CABEZA-STEVE "blue" 33 34 68 34) PATAS-ISAAC BRAZO-IZQ-ISAAC BRAZO-DERE-ISAAC)))|#


#|PRIMER-RUN-MOVIE-JOAQUIN
...
#|TERCER-RUN-MOVIE-JOAQUIN
(run-movie 0.2 (list
(fabrica-frank-numero-dos-joaqui CUERPO-HOLLOW (CABEZA-ISAAC 50) PIERNAS-HOLLOW MOCHILA-AMONGUS)
(fabrica-frank-numero-dos-joaqui CUERPO-HOLLOW (CABEZA-ISAAC 52) PIERNAS-HOLLOW MOCHILA-AMONGUS)
(fabrica-frank-numero-dos-joaqui CUERPO-HOLLOW (CABEZA-ISAAC 54) PIERNAS-HOLLOW MOCHILA-AMONGUS)
(fabrica-frank-numero-dos-joaqui CUERPO-HOLLOW (CABEZA-ISAAC 56) PIERNAS-HOLLOW MOCHILA-AMONGUS)
(fabrica-frank-numero-dos-joaqui CUERPO-HOLLOW (CABEZA-ISAAC 58) PIERNAS-HOLLOW MOCHILA-AMONGUS)
(fabrica-frank-numero-dos-joaqui CUERPO-HOLLOW (CABEZA-ISAAC 60) PIERNAS-HOLLOW MOCHILA-AMONGUS)
(fabrica-frank-numero-dos-joaqui CUERPO-HOLLOW (CABEZA-ISAAC 62) PIERNAS-HOLLOW MOCHILA-AMONGUS)
(fabrica-frank-numero-dos-joaqui CUERPO-HOLLOW (CABEZA-ISAAC 64) PIERNAS-HOLLOW MOCHILA-AMONGUS)
(fabrica-frank-numero-dos-joaqui CUERPO-HOLLOW (CABEZA-ISAAC 66) PIERNAS-HOLLOW MOCHILA-AMONGUS)
(fabrica-frank-numero-dos-joaqui CUERPO-HOLLOW (CABEZA-ISAAC 68) PIERNAS-HOLLOW MOCHILA-AMONGUS)
(fabrica-frank-numero-dos-joaqui CUERPO-HOLLOW (CABEZA-ISAAC 70) PIERNAS-HOLLOW MOCHILA-AMONGUS)))|#
